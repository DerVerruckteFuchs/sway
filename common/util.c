...
const char *sway_wl_output_format_to_string(enum wl_shm_format format) {
	...
	case WL_SHM_FORMAT_ARGB8888:
		...
		return "8-bit RGB with alpha channel";
	case WL_SHM_FORMAT_XRGB8888:
		// 32-bit XRGB format, [31:0] x:R:G:B 8:8:8:8 little endian
		return "8-bit RGB without alpha channel";
	case WL_SHM_FORMAT_XBGR8888:
		// 32-bit xBGR format, [31:0] x:B:G:R 8:8:8:8 little endian
		return "8-bit BGR without alhpa channel";
	case WL_SHM_FORMAT_ABGR8888:
		// 32-bit ABGR format, [31:0] A:B:G:R 8:8:8:8 little endian
		return "8-bit BGR with alpha channel";
	// 10 bit formats
	case WL_SHM_FORMAT_ARGB2101010:
		// 32-bit ARGB format, [31:0] A:R:G:B 2:10:10:10 little endian
		return "10-bit RGB with alpha channel";
	case WL_SHM_FORMAT_XRGB2101010:
		// 32-bit xRGB format, [31:0] x:B:G:R 2:10:10:10 little endian
		return "10-bit RGB without alpha channel";
	case WL_SHM_FORMAT_XBGR2101010:
		// 32-bit xBGR format, [31:0] x:B:G:R 2:10:10:10 little endian
		return "10-bit BGR without alpha channel";
	case WL_SHM_FORMAT_ABGR2101010:
		// 32-bit ABGR format, [31:0] A:B:G:R 2:10:10:10 little endian
		return "10-bit BGR with alpha channel";
	default:
